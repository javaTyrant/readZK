...
public class QuorumPeerMain {
    ...
    /**
     * 注意:resources文件夹要设置一下 mark as resources
    ...
    private void setPeer(QuorumPeerConfig config, ServerCnxnFactory cnxnFactory, ServerCnxnFactory secureCnxnFactory) throws IOException {
        //获取一个quorumPeer,法人
